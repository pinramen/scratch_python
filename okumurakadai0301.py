...
sleep(0)
setPyramid(x=0, z=0, size=23, blockTypeId=41, blockData=0)
sleep(0)
setPyramid(x=0, z=0, size=27, blockTypeId=41, blockData=0)
sleep(0)
setPyramid(x=0, z=0, size=35, blockTypeId=41, blockData=0)
sleep(0)
setPyramid(x=0, z=0, size=51, blockTypeId=41, blockData=0)
sleep(0)
setPyramid(x=0, z=0, size=83, blockTypeId=41, blockData=0)
sleep(0)